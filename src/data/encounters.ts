...
export const ENCOUNTER_DEFS: EncounterDef[] = [
  ...
  },
  {
    ...
    faction: "lionsheart",
    isBoss: false,
    enemies: [{ name: "Kaan's Dueling Skiff", hull: 90, damage: 20, block: 6, evasion: 0.25 }],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Hawke's Warcutter", hull: 320, damage: 37, block: 12, evasion: 0.22 },
      { name: "Reaver Skiff", hull: 55, damage: 15, block: 3, evasion: 0.18 },
      { name: "Reaver Skiff", hull: 55, damage: 15, block: 3, evasion: 0.18 },
    ],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Swarm Drone", hull: 78, damage: 22, block: 0, evasion: 0.1, regen: 4, role: "mender" },
      { name: "Swarm Drone", hull: 125, damage: 32, block: 0, evasion: 0.1, regen: 4 },
      { name: "Swarm Drone", hull: 125, damage: 32, block: 0, evasion: 0.1, regen: 4 },
    ],
  ...
  },
  {
    ...
    fleetBattle: true,
    enemies: [
      { name: "Swarm Drone", hull: 60, damage: 17, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Drone", hull: 60, damage: 17, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Drone", hull: 60, damage: 17, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Broodling", hull: 240, damage: 31, block: 8, evasion: 0.1, regen: 10, role: "mender" },
    ],
  ...
  // --- Act III: Fractured Veil — Chitin Swarm at full doctrine (mass + regen).
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Swarm Warrior", hull: 56, damage: 77, block: 2, evasion: 0.12, regen: 9, role: "mender" },
      { name: "Swarm Warrior", hull: 90, damage: 100, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 90, damage: 100, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 90, damage: 100, block: 2, evasion: 0.12, regen: 9 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Swarm Broodling", hull: 260, damage: 138, block: 8, evasion: 0.1, regen: 12, role: "mender" },
      { name: "Swarm Warrior", hull: 95, damage: 100, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 95, damage: 100, block: 2, evasion: 0.12, regen: 9 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "The Broodmother", hull: 384, damage: 154, block: 14, evasion: 0.08, regen: 20, role: "mender" },
      { name: "Swarm Warrior", hull: 100, damage: 108, block: 3, evasion: 0.12, regen: 10 },
      { name: "Swarm Warrior", hull: 100, damage: 108, block: 3, evasion: 0.12, regen: 10 },
      { name: "Swarm Warrior", hull: 100, damage: 108, block: 3, evasion: 0.12, regen: 10 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Rift-Warped Hulk", hull: 520, damage: 185, block: 16, evasion: 0.05, role: "artillery" },
      { name: "Swarm Broodling", hull: 280, damage: 146, block: 9, evasion: 0.1, regen: 14, role: "mender" },
      { name: "Swarm Warrior", hull: 110, damage: 115, block: 3, evasion: 0.12, regen: 11 },
      { name: "Swarm Warrior", hull: 110, damage: 115, block: 3, evasion: 0.12, regen: 11 },
    ],
  ...
  // --- Act IV: Deep Origin — Mayeth Construct doctrine (heavy block, precise, no evasion).
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Construct Sentry Drone", hull: 43, damage: 54, block: 8, evasion: 0, role: "anchor" },
      { name: "Construct Sentry Drone", hull: 70, damage: 67, block: 8, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Construct Warden", hull: 480, damage: 148, block: 20, evasion: 0, role: "anchor" },
      { name: "Construct Sentry Drone", hull: 90, damage: 81, block: 10, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 90, damage: 81, block: 10, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Construct Warden", hull: 560, damage: 168, block: 22, evasion: 0, role: "anchor" },
      { name: "Construct Warden", hull: 560, damage: 168, block: 22, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 110, damage: 94, block: 12, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 110, damage: 94, block: 12, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Ark Custodian", hull: 900, damage: 202, block: 28, evasion: 0.05 },
      { name: "Construct Warden", hull: 480, damage: 155, block: 20, evasion: 0, role: "anchor" },
      { name: "Construct Warden", hull: 480, damage: 155, block: 20, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Hollow Vanguard", hull: 450, damage: 152, block: 18, evasion: 0.1, role: "anchor" },
      { name: "Hollow Wisp", hull: 166, damage: 123, block: 7, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 166, damage: 123, block: 7, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 166, damage: 123, block: 7, evasion: 0.15 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "The Hollow", hull: 900, damage: 195, block: 30, evasion: 0.08, role: "anchor" },
      { name: "Hollow Vanguard", hull: 778, damage: 217, block: 20, evasion: 0.1 },
      { name: "Hollow Wisp", hull: 207, damage: 137, block: 9, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 207, damage: 137, block: 9, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 207, damage: 137, block: 9, evasion: 0.15 },
    ],
  ...
  // layered on that confirmed premise, not sourced.
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Choir Acolyte", hull: 190, damage: 187, block: 9, evasion: 0.16, role: "mender" },
      { name: "Choir Acolyte", hull: 190, damage: 187, block: 9, evasion: 0.16 },
      { name: "Choir Acolyte", hull: 190, damage: 187, block: 9, evasion: 0.16 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Choir Herald", hull: 950, damage: 268, block: 18, evasion: 0.12 },
      { name: "Choir Cantor", hull: 320, damage: 196, block: 12, evasion: 0.14, role: "artillery" },
      { name: "Choir Cantor", hull: 320, damage: 196, block: 12, evasion: 0.14, role: "artillery" },
    ],
  ...
  },
  {
    ...
    fleetBattle: true,
    enemies: [
      { name: "The Conductor", hull: 1900, damage: 339, block: 26, evasion: 0.1 },
      { name: "Choir Herald", hull: 1000, damage: 285, block: 20, evasion: 0.12 },
      { name: "Choir Cantor", hull: 340, damage: 214, block: 13, evasion: 0.15, role: "artillery" },
      { name: "Choir Cantor", hull: 340, damage: 214, block: 13, evasion: 0.15, role: "artillery" },
    ],
...
export const BOUNTY_ENCOUNTER_DEFS: EncounterDef[] = [
  ...
  },
  {
    ...
    faction: "lionsheart",
    isBoss: false,
    enemies: [{ name: "Sparring Skiff", hull: 55, damage: 17, block: 4, evasion: 0.2 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Salvager Skiff", hull: 39, damage: 11, block: 3, evasion: 0.16, role: "artillery" },
      { name: "Salvager Skiff", hull: 39, damage: 11, block: 3, evasion: 0.16 },
    ],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Convoy Escort", hull: 24, damage: 7, block: 3, evasion: 0.1, role: "mender" },
      { name: "Convoy Hauler", hull: 39, damage: 11, block: 3, evasion: 0.05 },
    ],
  ...
  },
  {
    ...
    faction: "swanreach",
    isBoss: false,
    enemies: [{ name: "Smuggler Interceptor", hull: 320, damage: 86, block: 7, evasion: 0.18 }],
  ...
  },
  {
    ...
    faction: "swarm",
    isBoss: false,
    enemies: [{ name: "Swarm Straggler", hull: 188, damage: 223, block: 13, evasion: 0.1, regen: 16 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Rift Scavenger Drone", hull: 82, damage: 123, block: 9, evasion: 0.15, regen: 11, role: "mender" },
      { name: "Rift Scavenger Drone", hull: 133, damage: 162, block: 9, evasion: 0.15, regen: 11 },
    ],
  ...
  },
  {
    ...
    faction: "constructs",
    isBoss: false,
    enemies: [{ name: "Construct Outrider", hull: 349, damage: 363, block: 23, evasion: 0 }],
  ...
  },
  {
    ...
    faction: "hollow",
    isBoss: false,
    enemies: [{ name: "Hollow Echo", hull: 669, damage: 730, block: 43, evasion: 0.12 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Choir Acolyte", hull: 844, damage: 1177, block: 56, evasion: 0.15, role: "mender" },
      { name: "Choir Acolyte", hull: 844, damage: 1177, block: 56, evasion: 0.15 },
    ],
