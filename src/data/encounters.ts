...
export const BOUNTY_ENCOUNTER_DEFS: EncounterDef[] = [
  ...
  },
  {
    ...
    faction: "lionsheart",
    isBoss: false,
    enemies: [{ name: "Sparring Skiff", hull: 55, damage: 9, block: 4, evasion: 0.2 }],
  ...
  },
  {
    ...
    faction: "swanreach",
    isBoss: false,
    enemies: [{ name: "Smuggler Interceptor", hull: 102, damage: 16, block: 7, evasion: 0.18 }],
  ...
  },
  {
    ...
    faction: "swarm",
    isBoss: false,
    enemies: [{ name: "Swarm Straggler", hull: 188, damage: 29, block: 13, evasion: 0.1, regen: 16 }],
  ...
  },
  {
    ...
    faction: "constructs",
    isBoss: false,
    enemies: [{ name: "Construct Outrider", hull: 349, damage: 54, block: 23, evasion: 0 }],
  ...
  },
  {
    ...
    faction: "hollow",
    isBoss: false,
    enemies: [{ name: "Hollow Echo", hull: 645, damage: 101, block: 43, evasion: 0.12 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Choir Acolyte", hull: 844, damage: 132, block: 56, evasion: 0.15, role: "mender" },
      { name: "Choir Acolyte", hull: 844, damage: 132, block: 56, evasion: 0.15 },
    ],
