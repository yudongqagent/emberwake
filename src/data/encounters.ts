...
export const ENCOUNTER_DEFS: EncounterDef[] = [
  ...
  },
  {
    ...
    faction: "lionsheart",
    isBoss: false,
    enemies: [{ name: "Kaan's Dueling Skiff", hull: 93, damage: 35, block: 6, evasion: 0.25 }],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Hawke's Warcutter", hull: 332, damage: 63, block: 12, evasion: 0.22 },
      { name: "Reaver Skiff", hull: 57, damage: 25, block: 3, evasion: 0.18 },
      { name: "Reaver Skiff", hull: 57, damage: 25, block: 3, evasion: 0.18 },
    ],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Swarm Drone", hull: 89, damage: 45, block: 0, evasion: 0.1, regen: 4, role: "mender" },
      { name: "Swarm Drone", hull: 142, damage: 67, block: 0, evasion: 0.1, regen: 4 },
      { name: "Swarm Drone", hull: 142, damage: 67, block: 0, evasion: 0.1, regen: 4 },
    ],
  ...
  },
  {
    ...
    fleetBattle: true,
    enemies: [
      { name: "Swarm Drone", hull: 62, damage: 29, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Drone", hull: 62, damage: 29, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Drone", hull: 62, damage: 29, block: 0, evasion: 0.12, regen: 6 },
      { name: "Swarm Broodling", hull: 249, damage: 54, block: 8, evasion: 0.1, regen: 10, role: "mender" },
    ],
  ...
  // --- Act III: Fractured Veil — Chitin Swarm at full doctrine (mass + regen).
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Swarm Warrior", hull: 137, damage: 116, block: 2, evasion: 0.12, regen: 9, role: "mender" },
      { name: "Swarm Warrior", hull: 219, damage: 150, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 219, damage: 150, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 219, damage: 150, block: 2, evasion: 0.12, regen: 9 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Swarm Broodling", hull: 634, damage: 208, block: 8, evasion: 0.1, regen: 12, role: "mender" },
      { name: "Swarm Warrior", hull: 232, damage: 150, block: 2, evasion: 0.12, regen: 9 },
      { name: "Swarm Warrior", hull: 232, damage: 150, block: 2, evasion: 0.12, regen: 9 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "The Broodmother", hull: 936, damage: 231, block: 14, evasion: 0.08, regen: 20, role: "mender" },
      { name: "Swarm Warrior", hull: 244, damage: 162, block: 3, evasion: 0.12, regen: 10 },
      { name: "Swarm Warrior", hull: 244, damage: 162, block: 3, evasion: 0.12, regen: 10 },
      { name: "Swarm Warrior", hull: 244, damage: 162, block: 3, evasion: 0.12, regen: 10 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Rift-Warped Hulk", hull: 1268, damage: 278, block: 16, evasion: 0.05, role: "artillery" },
      { name: "Swarm Broodling", hull: 683, damage: 220, block: 9, evasion: 0.1, regen: 14, role: "mender" },
      { name: "Swarm Warrior", hull: 268, damage: 173, block: 3, evasion: 0.12, regen: 11 },
      { name: "Swarm Warrior", hull: 268, damage: 173, block: 3, evasion: 0.12, regen: 11 },
    ],
  ...
  // --- Act IV: Deep Origin — Mayeth Construct doctrine (heavy block, precise, no evasion).
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Construct Sentry Drone", hull: 98, damage: 103, block: 8, evasion: 0, role: "anchor" },
      { name: "Construct Sentry Drone", hull: 160, damage: 128, block: 8, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Construct Warden", hull: 1095, damage: 283, block: 20, evasion: 0, role: "anchor" },
      { name: "Construct Sentry Drone", hull: 205, damage: 154, block: 10, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 205, damage: 154, block: 10, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Construct Warden", hull: 1278, damage: 321, block: 22, evasion: 0, role: "anchor" },
      { name: "Construct Warden", hull: 1278, damage: 321, block: 22, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 251, damage: 180, block: 12, evasion: 0 },
      { name: "Construct Sentry Drone", hull: 251, damage: 180, block: 12, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Ark Custodian", hull: 2054, damage: 385, block: 28, evasion: 0.05 },
      { name: "Construct Warden", hull: 1095, damage: 295, block: 20, evasion: 0, role: "anchor" },
      { name: "Construct Warden", hull: 1095, damage: 295, block: 20, evasion: 0 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Hollow Vanguard", hull: 2151, damage: 628, block: 18, evasion: 0.1, role: "anchor" },
      { name: "Hollow Wisp", hull: 793, damage: 508, block: 7, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 793, damage: 508, block: 7, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 793, damage: 508, block: 7, evasion: 0.15 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "The Hollow", hull: 4303, damage: 807, block: 30, evasion: 0.08, role: "anchor" },
      { name: "Hollow Vanguard", hull: 3718, damage: 897, block: 20, evasion: 0.1 },
      { name: "Hollow Wisp", hull: 991, damage: 568, block: 9, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 991, damage: 568, block: 9, evasion: 0.15 },
      { name: "Hollow Wisp", hull: 991, damage: 568, block: 9, evasion: 0.15 },
    ],
  ...
  // layered on that confirmed premise, not sourced.
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Choir Acolyte", hull: 1150, damage: 801, block: 9, evasion: 0.16, role: "mender" },
      { name: "Choir Acolyte", hull: 1150, damage: 801, block: 9, evasion: 0.16 },
      { name: "Choir Acolyte", hull: 1150, damage: 801, block: 9, evasion: 0.16 },
    ],
  ...
  },
  {
    ...
    isBoss: true,
    enemies: [
      { name: "Choir Herald", hull: 5752, damage: 1144, block: 18, evasion: 0.12 },
      { name: "Choir Cantor", hull: 1938, damage: 839, block: 12, evasion: 0.14, role: "artillery" },
      { name: "Choir Cantor", hull: 1938, damage: 839, block: 12, evasion: 0.14, role: "artillery" },
    ],
  ...
  },
  {
    ...
    fleetBattle: true,
    enemies: [
      { name: "The Conductor", hull: 11504, damage: 1450, block: 26, evasion: 0.1 },
      { name: "Choir Herald", hull: 6055, damage: 1221, block: 20, evasion: 0.12 },
      { name: "Choir Cantor", hull: 2059, damage: 915, block: 13, evasion: 0.15, role: "artillery" },
      { name: "Choir Cantor", hull: 2059, damage: 915, block: 13, evasion: 0.15, role: "artillery" },
    ],
...
export const BOUNTY_ENCOUNTER_DEFS: EncounterDef[] = [
  ...
  },
  {
    ...
    faction: "lionsheart",
    isBoss: false,
    enemies: [{ name: "Sparring Skiff", hull: 57, damage: 29, block: 4, evasion: 0.2 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Salvager Skiff", hull: 41, damage: 19, block: 3, evasion: 0.16, role: "artillery" },
      { name: "Salvager Skiff", hull: 41, damage: 19, block: 3, evasion: 0.16 },
    ],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Convoy Escort", hull: 25, damage: 13, block: 3, evasion: 0.1, role: "mender" },
      { name: "Convoy Hauler", hull: 41, damage: 19, block: 3, evasion: 0.05 },
    ],
  ...
  },
  {
    ...
    faction: "swanreach",
    isBoss: false,
    enemies: [{ name: "Smuggler Interceptor", hull: 361, damage: 178, block: 7, evasion: 0.18 }],
  ...
  },
  {
    ...
    faction: "swarm",
    isBoss: false,
    enemies: [{ name: "Swarm Straggler", hull: 458, damage: 335, block: 13, evasion: 0.1, regen: 16 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Rift Scavenger Drone", hull: 200, damage: 185, block: 9, evasion: 0.15, regen: 11, role: "mender" },
      { name: "Rift Scavenger Drone", hull: 324, damage: 243, block: 9, evasion: 0.15, regen: 11 },
    ],
  ...
  },
  {
    ...
    faction: "constructs",
    isBoss: false,
    enemies: [{ name: "Construct Outrider", hull: 796, damage: 694, block: 23, evasion: 0 }],
  ...
  },
  {
    ...
    faction: "hollow",
    isBoss: false,
    enemies: [{ name: "Hollow Echo", hull: 3197, damage: 1703, block: 43, evasion: 0.12 }],
  ...
  },
  {
    ...
    isBoss: false,
    enemies: [
      { name: "Choir Acolyte", hull: 5110, damage: 2746, block: 56, evasion: 0.15, role: "mender" },
      { name: "Choir Acolyte", hull: 5110, damage: 2746, block: 56, evasion: 0.15 },
    ],
