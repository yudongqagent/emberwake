...
export const ACT5_SCENES: StoryScene[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { speaker: "Kade Ren", text: "Is one of them you?" },
      { speaker: "The Cinder", text: "Several. Don't listen for it. That's how the Line takes people." },
    ],
  ...
  },
  {
    ...
    lines: [
      ...
      { speaker: "Kade Ren", text: "And now?" },
      { speaker: "The Cinder", text: "Now I have one ship, rebuilt eleven times by a man who wasn't supposed to live this long. Burn it all, Kade. Everything she has." },
    ],
