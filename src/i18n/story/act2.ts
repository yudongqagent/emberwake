...
export const ACT2_SCENES_ZH: Record<string, Partial<Pick<StoryScene, "lines" | "choices" | "chapter" | "chapterTitle">>> = {
  openLanes: {
    ...
    lines: [
      ...
      { speaker: "铁衡", text: "我十九岁那年成过一次那种故事。花了六年才让人改口。你别走这条路。" },
  ...
  tradeWinds: {
    ...
    lines: [
      ...
      { speaker: "柳芸", text: "另外一句私话:能把船改成这样的人，一般活不长。我押你能活。别让我赔。" },
  ...
  firstContact: {
    ...
    lines: [
      ...
      { speaker: "陆昭", text: "它们从没来过这么里面。是被什么赶过来的。" },
      { speaker: "余烬", text: "被更外面的东西赶的。真正该怕的是那个。" },
    ],
  },
  reachOpens: {
    chapter: "铁门星域",
    ...
    lines: [
      ...
      { speaker: "铁衡", text: "我认识的人里，说这种话的都死了。你别是第一个例外——例外这种事，靠不住。" },
