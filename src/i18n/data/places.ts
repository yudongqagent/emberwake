...
export const GALAXY_NAMES_ZH: Record<string, string> = {
  bauhiniaReach: "洋紫荆疆域",
  lionsheartExpanse: "狮心疆域",
  swanreachCombine: "天鹅域联合体",
  fracturedVeil: "破碎帷幕",
  deepOrigin: "深层本源",
  umbralLine: "暗影线",
  chorusDeep: "合唱深域",
